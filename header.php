...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (basename($_SERVER['PHP_SELF']) == 'bukuphp') ? 'active' : ''; ?>" href="buku.php"><i class="fas fa-book-open"></i> Buku</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= (basename($_SERVER['PHP_SELF']) == 'history_peminjaman.php') ? 'active' : ''; ?>" href="histori_peminjaman.php"><i class="fas fa-history"></i> Histori</a>
                </li>
                <li class="nav-item">
  ...
  <div class="container mt-4"> </div> </body>
